...
- Keep Docs Updated: Ensure Specification.md, README.md, and README-DEV.md are always up-to-date.
...
- Color Identity: Use #0866ff as the primary brand color throughout the application.
- Internationalization (i18n): The application must support multiple languages. Avoid hardcoding text strings; use localization keys instead to facilitate easy translation.